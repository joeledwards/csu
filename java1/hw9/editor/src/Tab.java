...
implements ActionListener, CaretListener, ChangeListener, DocumentListener
{
    ...
    private static ImageIcon modifiedTabIcon = Resources.getAsImageIcon("resources/icons/modified.png", 16, 16);
    private static ImageIcon freshTabIcon  = Resources.getAsImageIcon("resources/icons/fresh.png", 16, 16);
    private static ImageIcon savedTabIcon  = Resources.getAsImageIcon("resources/icons/saved.png", 16, 16);
    ...
    public Tab(Editor parent, JTabbedPane pane, File file, boolean isDoubleBuffered)
    {
    ...
    public void close() {
        boolean remove = true;
        if (!isSaved()) {
            JOptionPane confirm = new JOptionPane("This tab's contents have been modified. Do you wish to close without saving?",
                                                  JOptionPane.QUESTION_MESSAGE,
                                                  JOptionPane.YES_NO_OPTION,
                                                  UIManager.getIcon("OptionPane.questionIcon"));
